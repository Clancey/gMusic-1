...
{
	public class PlaylistViewController : BaseViewController , IBaseViewController
	{
		bool IsAutoPlaylist;
		PlaylistViewModel model;
		public PlaylistViewController() : this(false)
		{

		}
		public PlaylistViewController(bool isAutoPlaylist)
		{
