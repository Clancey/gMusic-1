...
public static class Reachability
{
	...
	public static bool IsHostReachable (string host)
	{
		...
		catch(Exception ex)
		{
			...
			Console.WriteLine("Trying reachability again");
	...
	{
#if DEBUG
		flags =  NetworkReachabilityFlags.ConnectionAutomatic;
		return true;
#endif
		if(defaultRouteReachability != null)
			defaultRouteReachability.Unschedule(CFRunLoop.Current, CFRunLoop.ModeDefault);
		//if (defaultRouteReachability == null) {
