	...
	public class PlayerViewController : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			try {
				...
				this.NavigationItem.LeftBarButtonItem = new UIBarButtonItem ("Back".Translate(), UIBarButtonItemStyle.Bordered, delegate {
					...
					Util.MainViewController.NavigationController.SelectedIndex = Settings.CurrentTab;
				...
				NSLogWriter.Default.WriteLine ("Error on view will appear: " + ex);	
			}
		...
		public override void ViewDidAppear (bool animated)
		{
			try {
				...
				NSLogWriter.Default.WriteLine ("Error on view did appear: " + ex);					
			}
		}
		...
		public override void ViewWillDisappear (bool animated)
		{
			try {
				...
				NSLogWriter.Default.WriteLine ("Error in view will disapear	" + ex);
			}
		}
		...
		public override void ViewDidDisappear (bool animated)
		{
			try {
				...
				NSLogWriter.Default.WriteLine ("Error in view did disapear" + ex);
			}
		}
		...
		public void SetState (bool isPlaying)
		{
			try {
				...
				//Util.UpdateMpNowPlaying();
					...
					//NSLogWriter.Default.WriteLine(MPMediaItem.TitleProperty);
					//NSLogWriter.Default.WriteLine(MPNowPlayingInfoCenter.NowPlayingTitle);
				//}
				...
				NSLogWriter.Default.WriteLine ("error in SetState :" + ex);	
			}
			
		}
		public void UpdateSong (Song currentSong)
		{
			titleView.SongTitle.Text = currentSong.Title;
			titleView.ArtistTitle.Text = currentSong.Artist;
			albumView.SetImage (currentSong.AlbumImage);
			albumButton.SetImage(Util.CurrentSong.AlbumImage, UIControlState.Normal);
			try{
				currentVC.Reload(currentSong);
			}
			catch(Exception ex)
			{
		...
		public void SetPlayCount ()
		{
			try {
				...
				NSLogWriter.Default.WriteLine ("error in setPlayCount	" + ex);
			}
		}
