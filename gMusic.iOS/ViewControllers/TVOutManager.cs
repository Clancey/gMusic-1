...
namespace TVOutManager {
	...
	public class TVOutManager {
		...
		public static UIWindow tvoutWindow, deviceWindow;
		...
		public TVOutManager ()
		{
			...
			NSNotificationCenter.DefaultCenter.AddObserver ("UIDeviceOrientationDidChangeNotification",
				(notify) =>
				{
					if (UseVC || mirrorView == null || done == true) { notify.Dispose (); return; }
		...
		public void startTVOut ()
		{
			...
			tvoutWindow.UserInteractionEnabled = true;
			...
			Pioneer.PPioneerManager.SharedPioneerManager.SubWindow = tvoutWindow ;
			...
			if(UseVC)
			{
				tvoutWindow.Transform = CGAffineTransform.MakeScale (1.1f, 1f);
				tvoutWindow.RootViewController = VC;
				return;
			}
